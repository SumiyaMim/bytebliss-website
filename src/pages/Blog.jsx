...
const Blog = () => {
  ...
  const { comments_count, title, reading_time_minutes, public_reactions_count} = blog
  ...
  return (
    <div className='max-w-3xl px-5 md:px-9 lg:px-6 py-16 mx-auto space-y-12 overflow-hidden'>
